...
class TreeGenerator(object):
    ...
    def get_trees(self):
        ...
        print("=======================") # added this
        print("chart:")
        for each in self.chart:
            print(each)
        print("=======================") # added this
        print("top_arc:")
        print(top_arc)
        print("=======================") # added this
        print("passive_edges:") # added this
        for each in self.passive_edges: # added this
            print(each) # added this
        print("=======================") # added this
    ...
    def __is_terminant(self, arc):
        #rule_rhs = str(arc[0].rhs())
        #print("rule_rhs:", rule_rhs)
        rule_rhs = str(arc[0])
        one_sing_quote = rule_rhs.find("\'")
        return True if (one_sing_quote >= 0) else False
    ...
    def __format_parse_tree(self, parse_list):
        ...
        parse_tree = Tree.fromstring(tmp_str_e)
        return parse_tree
